...
function Experience() {
  ...
  const experiences = [
    ...
    },
    {
      ...
      descriptionPoint:[
        `Managed and analyzed indoor air quality data as a Data Analyst at the Applied Infectious Disease and Epidemiology Lab at Arizona State University.
        Utilized predictive modeling and statistical techniques to process extensive datasets, resulting in actionable insights.
        Conducted rigorous field tests to validate data collection instruments, ensuring data integrity.
        Created visually engaging visualizations using D3.JS to communicate complex data trends effectively.
        Coordinated data collection efforts and facilitated informed decision-making among team members and partners.
        Achieved a significant 30-40% reduction in indoor air pollutants through contributions to the efficacy of the Corsi-Rosenthal box.
        Developed protocols for humidifier experiments and automated data management processes, showcasing analytical prowess.
        Contributed as a published author to the study "Effectiveness of Do-It-Yourself Portable Air Cleaners in Reducing Exposure to Respiratory Aerosols in US Classrooms," currently under review with Science & Education Journal, demonstrating expertise in data analysis and interpretation.`
      ]
    },
    {
